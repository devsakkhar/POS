                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <b class="cs-primary_color">Date: </b>{{ Carbon\Carbon::parse($date)->format('d-m-Y') }}
                                    </td>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="text-align: right;"><b class="cs-primary_color">Pay To:</b>
                                            <p>
                                                Rakhi Enterprise <br>
                                                Global Electronics Brand Shop <br>
                                                Shaid Abul Kashem Road, Chuadanga <br>
                                                +88 01714968739, +88 01609174149
                                            </p>
                                        </td>
                                    </tr>
                                </tbody>
                                    ...
                                    <table>
                                        <tbody>
                                            <tr class="cs-border_left">
                                                <td class="cs-width_3 cs-semi_bold cs-primary_color cs-focus_bg">Paid Amout</td>
                                                <td class="cs-width_3 cs-semi_bold cs-focus_bg cs-primary_color cs-text_right">{{ $sale->total-$sale->due_amount }}Tk</td>
                                            </tr>

                                            <tr class="cs-border_left">
                                                <td class="cs-width_3 cs-semi_bold cs-primary_color cs-focus_bg">Due Amount</td>
                                                <td class="cs-width_3 cs-semi_bold cs-focus_bg cs-primary_color cs-text_right">{{ $sale->due_amount }}Tk</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
